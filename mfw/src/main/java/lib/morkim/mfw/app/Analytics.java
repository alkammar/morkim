...
public interface Analytics {
	...
	void sendAutoEvent(String category, String action);
	void sendAutoEvent(String category, String action, long value);
	void sendAutoEvent(String category, String action, String label);
	void sendAutoEvent(String category, String action, String label, long value);
